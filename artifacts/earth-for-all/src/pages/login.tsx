...
import { Globe, Mail, Lock, ArrowRight, Eye, EyeOff, Smartphone } from "lucide-react";
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col gap-3">
          <button type="button" onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-2 bg-white/5 border border-white/10 rounded-xl py-2.5 text-sm text-white/70 hover:bg-white/10 hover:text-white transition-all">

    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center"><span className="bg-background px-3 text-xs text-white/30">or continue with</span></div>
        </div>

        <div className="flex gap-3">
          <button type="button" onClick={() => handleOAuth(loginWithGoogle)}
            className="flex-1 flex items-center justify-center gap-2 bg-white/5 border border-white/10 rounded-xl py-2.5 text-sm text-white/70 hover:bg-white/10 hover:text-white transition-all">
          ...
          <button type="button" onClick={() => handleOAuth(loginWithGitHub)}
            className="flex-1 flex items-center justify-center gap-2 bg-white/5 border border-white/10 rounded-xl py-2.5 text-sm text-white/70 hover:bg-white/10 hover:text-white transition-all">
